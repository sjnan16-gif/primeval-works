...
| Processor | Working | A four-slot fuel machine with material, fuel, catalyst, and output slots. It refines both ancient ingot chains, compresses Ancient Metal/Cores, and upgrades the Wind Turbine. Transporters honor per-slot insert/extract controls, and an assigned Fire worker accelerates valid active work. |
